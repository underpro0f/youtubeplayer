...
class SocialProfileEditView(SocialProfileView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        sp_form = SocialProfileForm(request.POST, request.FILES or None, instance=request.user.social_profile)
...
def signup_success(request, template_name='accounts/signup_success.html'):
...
def user_list(request, template_name='accounts/user_list.html'):
    ...
    context = {
        'user_list': User.objects.all().values('username', 'email', 'social_profile__description', 'social_profile__avatar')
    }
