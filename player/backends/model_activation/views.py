...
from player import signals
from player.models import RegistrationProfile
from player.views import ActivationView as BaseActivationView
from player.views import RegistrationView as BaseRegistrationView
