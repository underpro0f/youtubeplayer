...
urlpatterns = [
    url(r'^activate/complete/$',
        TemplateView.as_view(
            template_name='player/activation_complete.html'
        ),
    ...
    url(r'^register/complete/$',
        TemplateView.as_view(
            template_name='player/registration_complete.html'
        ),
        name='registration_complete'),
    url(r'^register/closed/$',
        TemplateView.as_view(
            template_name='player/registration_closed.html'
        ),
        name='registration_disallowed'),
    url(r'', include('player.auth_urls')),
]
